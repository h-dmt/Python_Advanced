...
print(food_orders_app.add_meals_to_menu(
    french_toast, "dummy",  hummus_and_avocado_sandwich,
...
food = {"Hummus and Avocado Sandwich": 5,
        "Risotto with Wild Mushrooms": 48,
...
print(f"first order \nrisotto: {risotto_with_wild_mushrooms.quantity}\nhummus: {hummus_and_avocado_sandwich.quantity}\n" \
f"tortilla: {tortilla_with_beef_and_pork.quantity}")
